...
[![Bytewax User Guide](https://img.shields.io/badge/user-guide-brightgreen?style=flat-square)](https://docs.bytewax.io/projects/bytewax-ordering/en/stable/index.html)
...
`bytewax-ordering` is commercially licensed with publicly available
